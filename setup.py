...
download_url = 'https://github.com/rollyar/account_retencion_ar/tree/%s' % branch

LINKS = {
    'trytonar_account_voucher_ar': ('git+https://github.com/rollyar/'
        'account_voucher_ar.git@%s#egg=trytonar_account_voucher_ar-%s' %
        (branch, series)),
    }
